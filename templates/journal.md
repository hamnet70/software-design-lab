...
<font color="#FF0134">**Questions for Patrick**</font>: It seems necessary to install the code command every time VS Code is open or a new Terminal session is open. Is that true? Do you just leave both open all the time?
